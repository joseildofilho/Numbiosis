...
import ufpb.ci.numbiosis.modules.two.methods.JacobiRichardson
...
class JacobiMethodFragment : Fragment() {

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
                              savedInstanceState: Bundle?): View? {
        val view = inflater.inflate(R.layout.fragment_jacobi_method, container, false)
    ...
    private fun calculate(view: View){
        ...
        val result = JacobiRichardson.run(linearSystem, startVector, tolerance, iterations)

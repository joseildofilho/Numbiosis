...
import ufpb.ci.numbiosis.modules.three.methods.HeunsMethod


class HeunsMethodFragment : Fragment() {

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
                              savedInstanceState: Bundle?): View? {

        val view = inflater.inflate(R.layout.fragment_heuns_method, container, false)
    ...
    private fun calculate(view: View){
        ...
        val result = HeunsMethod.run(function, initial, h, n)
